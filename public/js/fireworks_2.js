...
// document.getElementById("fireworks-btn").addEventListener("mousedown", () => {
//   onFire = true;
// });
// document.getElementById("fireworks-btn").addEventListener("mouseup", () => {
//   onFire = false;
// });
function fireworksPowered() {
  onFire = true;
}
